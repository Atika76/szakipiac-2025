(function (root, factory) {
  ...
  function mount() {
    ...
    meta.innerHTML = `<summary class="cursor-pointer font-black text-indigo-950">Ajánlat azonosítása és feltételei</summary><div class="mt-4 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <label class="text-xs font-bold">Állapot<select id="quote_status" disabled class="mt-1 w-full rounded-lg border bg-slate-100 p-2"><option value="draft">Piszkozat</option><option value="sent">Elküldve</option><option value="viewed">Megtekintve</option><option value="accepted">Elfogadva</option><option value="rejected">Elutasítva</option><option value="expired">Lejárt</option></select><span class="text-[11px] text-slate-500">Az állapotot az online ajánlati folyamat frissíti.</span></label>
